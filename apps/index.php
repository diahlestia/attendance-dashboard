              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="mt-4 text-center small">
                    <span class="mr-2">
                      <i class="fas fa-circle text-primary"></i> Personalia
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-success"></i> Keuangan
                    </span>
                    <span class="mr-2">
                      <i class="fas fa-circle text-info"></i> Produksi
                    </span>
                  </div>
                </div>
              </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Arducoding</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
